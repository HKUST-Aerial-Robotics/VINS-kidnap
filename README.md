...
**A MORE UPTO DATE README IS AVAILABLE IN THE ORIGINAL REPO ([mpkuse/cerebro](https://github.com/mpkuse/cerebro) )**
...
- [Theia-sfm](http://theia-sfm.org/)
      ...
      - [RocksDB](https://github.com/facebook/rocksdb). tested with version v5.9.2
